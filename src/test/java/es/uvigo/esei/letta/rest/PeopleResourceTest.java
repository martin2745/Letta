...
import static es.uvigo.esei.letta.dataset.PeopleDataset.existentId;
import static es.uvigo.esei.letta.dataset.PeopleDataset.existentPerson;
import static es.uvigo.esei.letta.dataset.PeopleDataset.newName;
import static es.uvigo.esei.letta.dataset.PeopleDataset.newPerson;
import static es.uvigo.esei.letta.dataset.PeopleDataset.newSurname;
import static es.uvigo.esei.letta.dataset.PeopleDataset.nonExistentId;
import static es.uvigo.esei.letta.dataset.PeopleDataset.people;
...
import static es.uvigo.esei.letta.matchers.IsEqualToPerson.containsPeopleInAnyOrder;
import static es.uvigo.esei.letta.matchers.IsEqualToPerson.equalsToPerson;
