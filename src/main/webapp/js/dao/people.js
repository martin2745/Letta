...
//        };
	...
	this.deletePerson = function(person, done, fail, always) {
	    requestByAjax({
		url : resourcePath + person.id + "/" + person.login,
		type : 'DELETE',
	    }, done, fail, always);
	};
        ...
        this.getData = function(login, done, fail, always){
            requestByAjax({
                url : resourcePath + "userProfile/" + login,
                type : 'GET',
            },done, fail, always);
        };
        ...
        this.getRole = function (login, done, fail, always) {
            requestByAjax({
                url: resourcePath + "role/" + login,
                type: 'GET'
            }, done, fail, always);
        };
